...
public class Triangle extends GeometricObject {
	...
	/**
	 * Construct a triangle, extension of geometric object, with 3 args: doubles
	 * that will be the values of the sides of the triangle created.
	 * 
	...
	public String toString() {
		if (this.isFilled())
			try {
				return ("The length of the sides are " + side1 + ", " + side2 + ", and " + side3 + ". The color is "
						+ getColor() + ". It is filled. The area is " + getArea() + ", the perimeter is "
						+ getPerimeter());
			...
			try {
				return ("The length of the sides are " + side1 + ", " + side2 + ", and " + side3 + ". The color is "
						+ getColor() + ". It is not filled. The area is " + getArea() + ", the perimeter is "
						+ getPerimeter());
			} catch (TriangleException e) {
				e.printStackTrace();
				return ("Your triangle isn't real!");
